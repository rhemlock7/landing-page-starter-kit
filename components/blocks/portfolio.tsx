...
function GalleryItem({ item }: { item: (typeof portfolioItems)[0] }) {
  ...
  return (
    <div className="group relative overflow-hidden cursor-pointer">
      {/* Image placeholder */}
      <div
        className={`${aspectClass} w-full bg-gradient-to-br from-secondary via-card to-muted relative overflow-hidden`}
      >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto font-light leading-relaxed">
            A curated collection of moments frozen in time, each telling its own
            unique story through the interplay of light and shadow.
          </p>
        </div>
